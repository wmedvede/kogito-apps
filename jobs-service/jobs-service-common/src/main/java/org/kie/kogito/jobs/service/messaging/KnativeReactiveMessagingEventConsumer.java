...
public class KnativeReactiveMessagingEventConsumer extends ReactiveMessagingEventConsumer {
    ...
    private static final String KOGITO_JOB_SERVICE_JOB_REQUEST_KNATIVE_EVENTS = "kogito-job-service-job-request-knative-events";
    ...
    @Incoming(KOGITO_JOB_SERVICE_JOB_REQUEST_KNATIVE_EVENTS)
