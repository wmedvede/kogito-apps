...
public class BasicAuthenticationCredentialsTest {
    ...
    @BeforeEach
    public void setUp() {
        credentials = new BasicAuthenticationCredentials(USER, PASSWORD);
    }
    ...
    @Test
    public void setUser() {
        credentials.setUser(VALUE);
        assertThat(credentials.getUser()).isEqualTo(VALUE);
    }

    @Test
    public void setPassword() {
        credentials.setPassword(VALUE);
        assertThat(credentials.getPassword()).isEqualTo(VALUE);
    }
}
