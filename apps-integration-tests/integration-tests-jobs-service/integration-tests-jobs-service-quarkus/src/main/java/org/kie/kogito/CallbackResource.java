...
/**
 * Helper resource for emulating the callback endpoint of a Job created by using the Job service events API.
 * Might be removed when the event based job service plugin is implemented.
 */
