...
public abstract class AbstractAuthenticationFilterProviderTest<T extends AuthenticationCredentials> {
    ...
    protected abstract AuthenticationFilterProvider<T> createProvider();

    protected abstract Class<T> getType();

    protected abstract T getCredentials();
