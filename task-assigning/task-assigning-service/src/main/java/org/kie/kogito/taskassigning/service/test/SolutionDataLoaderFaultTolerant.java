...
import org.kie.kogito.taskassigning.service.UserServiceConnectorLocator;
...
@ApplicationScoped
public class SolutionDataLoaderFaultTolerant {

    private static final Logger LOGGER = LoggerFactory.getLogger(SolutionDataLoaderFaultTolerant.class);
    ...
    @Inject
    public SolutionDataLoaderFaultTolerant(TaskServiceConnector taskServiceConnector,
