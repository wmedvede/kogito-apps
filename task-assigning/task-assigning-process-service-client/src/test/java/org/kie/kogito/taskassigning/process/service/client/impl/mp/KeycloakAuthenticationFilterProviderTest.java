...
public class KeycloakAuthenticationFilterProviderTest extends AbstractAuthenticationFilterProviderTest<KeycloakAuthenticationCredentials> {
    ...
    protected KeycloakAuthenticationCredentials getCredentials() {
        return new KeycloakAuthenticationCredentials(SERVER_URL, REALM, USER_NAME, PASSWORD, CLIENT_ID, CLIENT_SECRET);
    }
}
